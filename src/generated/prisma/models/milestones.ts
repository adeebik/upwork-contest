...
// @ts-nocheck 
/*
 * This file exports the `milestones` model and its related types.
 *
...
export type GetMilestonesAggregateType<T extends MilestonesAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateMilestones[P]>
    : Prisma.GetScalarType<T[P], AggregateMilestones[P]>
}
...
type GetMilestonesGroupByPayload<T extends milestonesGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<MilestonesGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof MilestonesGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], MilestonesGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], MilestonesGroupByOutputType[P]>
      }
    >
  >
...
export type milestonesCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface milestonesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends milestonesCountArgs>(
    args?: Prisma.Subset<T, milestonesCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], MilestonesCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, milestonesGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMilestonesGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
